...
class CheckedInVehicle {
  ...
  final String scheduledCheckOutDate;
  ...
  const CheckedInVehicle({
    ...
    required this.scheduledCheckOutDate,
  ...
  factory CheckedInVehicle.fromJson(Map<String, dynamic> json) =>
      CheckedInVehicle(
        ...
        scheduledCheckOutDate: (json['scheduled_check_out_date'] ??
                json['end_date'] ??
                json['check_out_date'])
            ?.toString() ??
            '',
        extraServices: json['extra_services']?.toString() ?? '',
        checkOutDatetime: json['check_out_datetime']?.toString() ?? '',
        checkOutByName: json['check_out_by_name']?.toString() ?? '',
        status: json['status']?.toString() ?? '',
      );

  CheckedInVehicle withScheduledCheckOutDate(String value) => CheckedInVehicle(
        id: id,
        referenceNumber: referenceNumber,
        checkInDatetime: checkInDatetime,
        checkInByName: checkInByName,
        scheduledCheckOutDate: value,
