...
class PersonalVehicleSummaryScreen extends StatefulWidget {
  ...
  State<PersonalVehicleSummaryScreen> createState() =>
      _PersonalVehicleSummaryScreenState();
}

class _PersonalVehicleSummaryScreenState
    extends State<PersonalVehicleSummaryScreen> {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text('No approved personal trips',
                style: TextStyle(
                    fontSize: 15,
